...
public class SenateCommittees {
  ...
  //  @Test(groups = { "senateCommittees" })
    ...
    public static void senateCommmittees25(String testId) throws InterruptedException, IOException {
       ...
       // driver.get("https://test.engagingnetworks.app/page/12929/action/1");
    }
    ...
    public static void senateCommmitteesAK(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/12930/action/1");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("You are not on the 2nd page",
                driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/12930/action/2"));
        ...
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12930/action/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void senateCommmitteesBanking(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/12940/action/1");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("You are not on the 2nd page",
                driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/12940/action/2"));
        ...
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12940/action/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void senateCommmitteesFL(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/12941/action/1");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("You are not on the 2nd page",
                driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/12941/action/2"));
        ...
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12941/action/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void senateCommmitteesCustTarget(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/12947/action/1");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("You are not on the 2nd page",
                driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/12947/action/2"));
        ...
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12947/action/3"));
