...
public class PB_B5_DON2PET {
    ...
    public static void donationToPetition(String testId) throws InterruptedException {
        driver.get("https://test.engagingnetworks.app/page/12582/donate/1?mode=DEMO");
        ...
        Assert.assertTrue("Didn't redirect to donation page",driver.getCurrentUrl().
                equals("https://test.engagingnetworks.app/page/12582/donate/2"));
        ...
        Assert.assertTrue("Didn't redirect to petition page",driver.getCurrentUrl().
                equals("https://test.engagingnetworks.app/page/10617/petition/1?chain"));
        ...
        Assert.assertTrue("Didn't redirect to donation page",driver.getCurrentUrl().
                equals("https://test.engagingnetworks.app/page/10617/petition/2"));
