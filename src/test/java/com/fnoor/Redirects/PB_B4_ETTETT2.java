...
public class PB_B4_ETTETT2 {
    ...
    public static void ETTtoETT2(String testId) throws InterruptedException {
        driver.get("https://test.engagingnetworks.app/page/12142/action/1?mode=DEMO");

        fields.selectTitle("Miss");
        fields.setFirstname("ETT");
        fields.setLastname("ToETT");
        ...
        Assert.assertTrue("Didn't redirect to second page",driver.getCurrentUrl().
                equals("https://test.engagingnetworks.app/page/12142/action/2"));
        ...
        Assert.assertTrue("Didn't redirect to donation page",driver.getCurrentUrl().
                equals("https://test.engagingnetworks.app/page/11068/action/2?chain"));
        ...
        fields.validateETTTargetMessage("Test message");
        fields.validateETTTargetMessage("Kind regards,");
        fields.validateETTTargetMessage("ETT ToETT");
        fields.submit();

        Assert.assertTrue("Didn't redirect to donation page",driver.getCurrentUrl().
                equals("https://test.engagingnetworks.app/page/11068/action/3"));

        String bodytext = driver.findElement(By.tagName("body")).getText();
        Assert.assertTrue("First name missing from last page ", bodytext.contains("ETT"));
