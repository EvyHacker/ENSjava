...
public class PAYFLOW {
    ...
    public static void payflowProSingle(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/10879/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/10879/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void payflowProRecurring(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/10880/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/10880/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void payflowProPayViaPaypal(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/10887/donate/1?ea.tracking.id=Twitter&mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("You didnt submit the payment",
            ...
            fields.waitForURLToChange("https://test.engagingnetworks.app/page/10887/donate/3");
            Assert.assertTrue("Urls are not the same",
                    driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/10887/donate/3"));
