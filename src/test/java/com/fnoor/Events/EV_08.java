...
public class EV_08 {
    ...
    public static void groupTicketsPayPal(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/12628/event/1");
        ...
        fields.waitForURLToChange("https://test.engagingnetworks.app/page/12628/event/2");
...
//		Assert that the payment was successful and the third page was reached
        Assert.assertTrue("Urls are not the same", driver.getCurrentUrl()
                .equals("https://test.engagingnetworks.app/page/12628/donate/3"));
