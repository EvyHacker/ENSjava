...
public class PB_A1_PET {
    ...
    public static void petition(String testId) throws InterruptedException{
        driver.get("https://test.engagingnetworks.app/page/10617/petition/1");
        ...
        Assert.assertTrue("Urls are not the same", myurlfinalUrl.equals("https://test.engagingnetworks.app/page/10617/petition/2"));
