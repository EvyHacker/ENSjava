...
public class PB_A10_TWT1 {
    ...
    public static void tweetCustomTarget(String testId) throws InterruptedException {
        driver.get("https://test.engagingnetworks.app/page/11981/tweet/1?mode=DEMO");

        fields.selectTitle("Miss");
        fields.setFirstname("Tweet");
        fields.setLastname("CustomTarget");
//		Call the createEmail function
        ...
        Assert.assertTrue("Didn't redirect to donation page",driver.getCurrentUrl().
                equals("https://test.engagingnetworks.app/page/11981/tweet/2"));
        //		Get the details from the third page and Verify the fields
        String bodytext = driver.findElement(By.tagName("body")).getText();
        Assert.assertTrue("First name missing from last page ", bodytext.contains("Tweet"));
        Assert.assertTrue("Last name missing from last page", bodytext.contains("CustomTarget"));
