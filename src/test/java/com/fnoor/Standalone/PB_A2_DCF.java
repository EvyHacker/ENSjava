...
public class PB_A2_DCF {
    ...
    public static void dataCapture(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/10621/data/1");
        ...
        Assert.assertTrue("Urls are not the same", myurlfinalUrl.equals("https://test.engagingnetworks.app/page/10621/data/3"));
