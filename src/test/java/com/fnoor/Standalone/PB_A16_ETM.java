...
public class PB_A16_ETM {
    ...
    public static void ecommerceSymbolicGift(String testId) throws InterruptedException {
        driver.get("https://test.engagingnetworks.app/page/12116/shop/1?ea.tracking.id=Google&utm_content=A16%20-%20Standalone%20Symbolic%20Gift&utm_campaign=utm_gift&utm_medium=paid%20social&utm_source=google");
        ...
        Assert.assertTrue(driver.getCurrentUrl().contains("https://test.engagingnetworks.app/page/12116/shop/4"));
        Assert.assertFalse(fields.verifyEmptyCartMsg().contains("Your cart is empty"));

        fields.ecommCheckout();
        fields.waitForPageLoad();
        //		Assert that the payment was successful and the third page was reached
        Assert.assertTrue(driver.getCurrentUrl().contains("https://test.engagingnetworks.app/page/12116/shop/5"));
        ...
        fields.waitForPageLoad();
        Assert.assertTrue(driver.getCurrentUrl().contains("https://test.engagingnetworks.app/page/12116/shop/6"));
        ...
        Assert.assertTrue("Urls are not the same", myurlfinal.equals("https://test.engagingnetworks.app/page/12116/shop/7"));
