...
public class PB_A17_MSP {
    ...
    public static void membershipDogsJoin(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/12120/membership/1?ea.tracking.id=mkx35hfo&utm_content=A17%20-%20Standalone%20Membership&utm_campaign=utm_member&utm_medium=email&utm_source=engagingnetworks\n");

        fields.field_MSP_Join.click();
        Assert.assertTrue(driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/12120/membership/2?membershipTypeId=71"));
...
//		Call the createEmail function
        ...
        Assert.assertTrue(driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/12120/membership/3"));
        ...
        Assert.assertTrue("Urls are not the same", driver.getCurrentUrl()
                .equals("https://test.engagingnetworks.app/page/12120/membership/4"));
