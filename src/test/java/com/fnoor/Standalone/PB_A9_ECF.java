...
public class PB_A9_ECF {
    ...
    public static void ecardValidation(String testId) throws InterruptedException {
        driver.get("https://test.engagingnetworks.app/page/11074/action/1");

        String new_email = fields.createEmail(testId);
        fields.setEmailAddress(new_email);
        fields.setFirstname("Standalone");
        fields.setLastname("Ecard");
        ...
        Assert.assertTrue("Urls are not the same",
                myurlfinal.equals("https://test.engagingnetworks.app/page/11074/action/2"));
        //		Get the details from the third page and Verify the fields
        String bodytext = driver.findElement(By.tagName("body")).getText();
        Assert.assertTrue("First name missing from last page ", bodytext.contains("Standalone"));
        Assert.assertTrue("Last name missing from last page", bodytext.contains("Ecard"));
