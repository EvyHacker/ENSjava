...
public class PB_A5_ETT2 {
    ...
    public static void singleDBETT(String testId) throws InterruptedException {
        driver.get("https://test.engagingnetworks.app/page/11069/action/1?mode=DEMO");
        ...
        Assert.assertTrue("Urls are not the same", myurlfinal.equals("https://test.engagingnetworks.app/page/11069/action/2"));
        ...
        Assert.assertTrue("Urls are not the same", myurlfinalUrl.equals("https://test.engagingnetworks.app/page/11069/action/3"));
