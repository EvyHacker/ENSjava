...
public class EV_02 {
    ...
    public static void singleFreeTicket(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/12620/event/1");
...
//
        fields.waitForURLToChange("https://test.engagingnetworks.app/page/12620/event/2");
        fields.verifyEventSummary("$0.00");
        fields.submit();

//		Assert that the payment was successful and the third page was reached
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12620/event/3"));
