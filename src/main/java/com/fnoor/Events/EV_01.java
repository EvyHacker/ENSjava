...
public class EV_01 {
    ...
    public static void singleTicketAddDonationIATS(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/12619/event/1");
...
//
        fields.waitForURLToChange("https://test.engagingnetworks.app/page/12619/event/2");
...
//		Assert that the payment was successful and the third page was reached
        ...
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12619/event/3"));
