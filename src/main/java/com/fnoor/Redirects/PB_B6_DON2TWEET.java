...
public class PB_B6_DON2TWEET {
    ...
    public static void donationToTweet(String testId) throws InterruptedException {
        driver.get("https://test.engagingnetworks.app/page/12596/donate/1?mode=DEMO");
        ...
        Assert.assertTrue("Didn't redirect to donation page",driver.getCurrentUrl().
                equals("https://test.engagingnetworks.app/page/12596/donate/2"));
        ...
        Assert.assertTrue("Didn't redirect to tweet page",driver.getCurrentUrl().
                equals("https://test.engagingnetworks.app/page/11070/tweet/1?chain"));
        ...
        Assert.assertTrue("Didn't redirect to donation page",driver.getCurrentUrl().
                equals("https://test.engagingnetworks.app/page/11070/tweet/2"));
