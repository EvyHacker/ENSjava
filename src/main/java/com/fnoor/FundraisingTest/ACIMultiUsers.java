...
public class ACIMultiUsers {
    ...
    public static void aciSingleVisaMultiUsers(String testId, PageFields fields, WebDriver driver) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/13031/donate/1");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/13031/donate/3"));
...
//		Get the details from the third page and Verify the fields
        ...
        driver.navigate().to("https://test.engagingnetworks.app/page/13031/donate/1");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", myurl1.equals("https://test.engagingnetworks.app/page/13031/donate/3"));
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", driver.getCurrentUrl()
                .equals("https://test.engagingnetworks.app/page/13031/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void aciRecurringVisaMultiUsers(String testId, PageFields fields, WebDriver driver) throws InterruptedException, IOException {
        ...
        //Testing Visa#4120300909000003 test number
        driver.get("https://test.engagingnetworks.app/page/13032/donate/1");
...
//		Call the createEmail function
        ...
        //		Assert that the payment was successful and the third page was reached
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/13032/donate/3"));
...
//		Get the details from the third page and Verify the fields
        ...
        //Testing Visa#4120300909000011 test number
        driver.navigate().to("https://test.engagingnetworks.app/page/13032/donate/1");
...
//		Call the createEmail function
        ...
        //		Assert that the payment was successful and the third page was reached
        String myurl1 = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl1.equals("https://test.engagingnetworks.app/page/13032/donate/3"));
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", driver.getCurrentUrl()
                .equals("https://test.engagingnetworks.app/page/13032/donate/3"));
