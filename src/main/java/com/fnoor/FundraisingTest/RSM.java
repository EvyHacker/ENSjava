...
public class RSM {
    ...
    public static void rsmSingle(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/846/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/846/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void rsmRecurring(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/870/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        //		Assert that the payment was successful and the third page was reached
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/870/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void rsmDirectDebit(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/847/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        //		Assert that the payment was successful and the third page was reached
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/847/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void rsm3DSingle(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/12784/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        //		Assert that the payment was successful and the third page was reached
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12784/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void rsm3DRecurring(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/12785/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        //		Assert that the payment was successful and the third page was reached
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12785/donate/3"));
