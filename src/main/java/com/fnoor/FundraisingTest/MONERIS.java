...
public class MONERIS {
    ...
    public static void moneriseSelectSingle(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/845/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/845/donate/3"));
...
//		Call the createEmail function
        ...
        fields.setCCNUmber("4740611374762707");
        fields.setCCExpiry(new CharSequence[]{"12", "2024"});
        fields.setCCV("123");
