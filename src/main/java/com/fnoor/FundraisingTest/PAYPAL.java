...
public class PAYPAL {
    ...
    public static void paypalPaymentsProSingle(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/843/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/843/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void payPalPaymentsProRecurring(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/865/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        //		Assert that the payment was successful and the third page was reached
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/865/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public  static void payViaPayPalSingle(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/844/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same",
                driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/844/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void payViaPayPalRecurring(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/866/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same",
                driver.getCurrentUrl().contains("https://www.sandbox.paypal.com/webscr?cmd"));
        fields.setPaypalEmail();
        ...
        Thread.sleep(4000);
            ...
            Assert.assertTrue("Urls are not the same",
                    driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/866/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void paypalViaPayPalCardinalComSingle3D(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.navigate().to("https://test.engagingnetworks.app/page/13376/donate/1?mode=DEMO");
...
//        page.getSupporterById(FUNDRAISING_TEST="paypalCardinalComRecurring3D", fields);
    ...
    public static void stripeViaPaypalSingle(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/12511/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same",  driver.getCurrentUrl()
                .equals("https://test.engagingnetworks.app/page/12511/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    @Parameters({"payViaPayPalDtDFee"})
    @Test(groups = { "paypal" })
    public  static void payViaPayPalDtDFee(String testId) throws InterruptedException, IOException {
        page.ensAuthTest();
        driver.get("https://test.engagingnetworks.app/page/13869/donate/1?mode=DEMO");


        fields.setDtD("Jackson Healthcare");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same",
                driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/13869/donate/3"));

        fields.getSupporterTaxID();

/*		Get the details from the third page and Verify the fields*/String bodytext = driver.findElement(By.tagName("body")).getText();
        Assert.assertTrue("Campaign ID not present", bodytext.contains("9752"));
        Assert.assertTrue("Gateway details are incorrect/not present", bodytext.contains("PayPal Gateway"));
        Assert.assertTrue("Donation Amount is incorrect/not present", bodytext.contains("$27.99"));
        Assert.assertTrue("Fee Amount is incorrect/not present", bodytext.contains("$12.99"));
        Assert.assertTrue("Currency is incorrect/not present", bodytext.contains("USD"));
        Assert.assertTrue("Donation type is incorrect/not present", bodytext.contains("CREDIT_SINGLE"));
        Assert.assertTrue("CC type is incorrect/ not present", bodytext.contains("TEST: Paypal"));

        page.getSupporterByEmail(FUNDRAISING_TEST="payViaPayPalDtDFee", fields);
        page.getSupporterById(FUNDRAISING_TEST="payViaPayPalDtDFee", fields);
    }
