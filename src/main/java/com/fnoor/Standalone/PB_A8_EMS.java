...
public class PB_A8_EMS {
    ...
    public static void signUp(String testId) throws InterruptedException {
        driver.get("https://test.engagingnetworks.app/page/11072/subscribe/1");
        ...
        Assert.assertTrue("Urls are not the same", myurlfinal.equals("https://test.engagingnetworks.app/page/11072/subscribe/2"));
