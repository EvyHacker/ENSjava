...
public class PB_A11_TWT2 {
    ...
    public static void singleDB(String testId) throws InterruptedException {
        driver.get("https://test.engagingnetworks.app/page/11071/tweet/1?mode=DEMO");

        fields.selectTitle("Miss");
        fields.setFirstname("Standalone");
        fields.setLastname("SingleDB");
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", myurlfinal.equals("https://test.engagingnetworks.app/page/11071/tweet/2"));
        //		Get the details from the third page and Verify the fields
        String bodytext = driver.findElement(By.tagName("body")).getText();
        Assert.assertTrue("First name missing from last page ", bodytext.contains("Standalone"));
        Assert.assertTrue("Last name missing from last page", bodytext.contains("SingleDB"));
