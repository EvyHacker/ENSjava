...
public class HouseCommittees {
    ...
    public static void houseCommmitteesOH(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/12942/action/1");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("You are not on the 2nd page",
                driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/12942/action/2"));
        ...
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12942/action/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void houseCommmitteesDefense(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/12944/action/1");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("You are not on the 2nd page",
                driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/12944/action/2"));
        ...
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12944/action/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void houseCommmitteesCA(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/12945/action/1");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("You are not on the 2nd page",
                driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/12945/action/2"));
        ...
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12945/action/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void houseCommmitteesCustTarget(String testId) throws InterruptedException, IOException {
        ...
        driver.get("https://test.engagingnetworks.app/page/12950/action/1");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("You are not on the 2nd page",
                driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/12950/action/2"));
        ...
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12950/action/3"));
