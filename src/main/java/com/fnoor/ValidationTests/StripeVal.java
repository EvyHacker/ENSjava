...
public class StripeVal {
    ...
    public static void stripeSingleVal(String testId, PageFields fields, WebDriver driver) throws InterruptedException, IOException {
        page.ensAuthTestVal();
        driver.navigate().to("https://test.engagingnetworks.app/page/12843/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12843/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void stripeSingle3DVal(String testId, PageFields fields, WebDriver driver) throws InterruptedException, IOException {
        page.ensAuthTestVal();
        driver.navigate().to("https://test.engagingnetworks.app/page/12841/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Didn't redirect to Submit payment page",
                myurliframe.equals("https://test.engagingnetworks.app/page/12841/donate/2"));
        ...
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12841/donate/3"));
