...
public class PaySafeVal {
    ...
    public static void paySafeSelectSingleVal(String testId, PageFields fields, WebDriver driver) throws InterruptedException, IOException {
        page.ensAuthTestVal();
        driver.get("https://test.engagingnetworks.app/page/12866/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12866/donate/3"));
...
//		Get the details from the third page and Verify the fields
    ...
    public static void paySafeSelectSingle3DVal(String testId, PageFields fields, WebDriver driver) throws InterruptedException, IOException {
        page.ensAuthTestVal();
        driver.get("https://test.engagingnetworks.app/page/12871/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Your transaction didn't go through" ,
                driver.getCurrentUrl().equals("https://test.engagingnetworks.app/page/12871/donate/2?val"));
        fields.submit();
        fields.waitForPageLoad();
        driver.switchTo().frame("Cardinal-CCA-IFrame");
        ...
        //		Assert that the payment was successful and the third page was reached
        String myurl = driver.getCurrentUrl();
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12871/donate/3"));
