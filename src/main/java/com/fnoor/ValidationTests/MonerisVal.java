...
public class MonerisVal {
    ...
    public static void moneriseSelectSingleVal(String testId, PageFields fields, WebDriver driver) throws InterruptedException, IOException {
        page.ensAuthTestVal();
        driver.get("https://test.engagingnetworks.app/page/12863/donate/1?mode=DEMO");
...
//        fields.setCCV("123");
        ...
        Assert.assertTrue("Urls are not the same", myurl.equals("https://test.engagingnetworks.app/page/12863/donate/3"));
...
//                equals("https://esqa.moneris.com/mpg/reports/transaction/index.php"));
    ...
    public static void moneriseSelectRecurringVal(String testId, PageFields fields, WebDriver driver) throws InterruptedException, IOException {
        page.ensAuthTestVal();
        driver.navigate().to("https://test.engagingnetworks.app/page/12863/donate/1?mode=DEMO");
...
//                equals("https://esqa.moneris.com/mpg/reports/transaction/index.php"));
    ...
    public static void moneriseSelectSingleVal3D(String testId, PageFields fields, WebDriver driver) throws InterruptedException, IOException {
        page.ensAuthTestVal();
        driver.navigate().to("https://test.engagingnetworks.app/page/12864/donate/1?mode=DEMO");
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", myurl1.equals("https://test.engagingnetworks.app/page/12864/donate/3"));
...
//		Call the createEmail function
        ...
        Assert.assertTrue("Urls are not the same", myurlFinal.equals("https://test.engagingnetworks.app/page/12863/donate/3"));
